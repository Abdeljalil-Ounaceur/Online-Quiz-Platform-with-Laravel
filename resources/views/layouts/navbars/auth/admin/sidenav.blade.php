<aside class="sidenav bg-somon navbar navbar-vertical navbar-expand-xs border border-dark border-1 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
    ...
    <ul class="navbar-nav">
      {{-- <li class="nav-item">
        <a class="nav-link {{ Route::currentRouteName() == 'home' ? 'active' : '' }}" href="{{ route('home') }}">
          <div class="icon icon-shape i icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-tv-2 text-primary text-white text-sm opacity-10"></i>
          </div>
